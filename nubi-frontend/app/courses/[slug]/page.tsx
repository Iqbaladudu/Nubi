        ...
        <div className="flex-auto w-auto lg:w-96 flex flex-col gap-6">
          ...
          <div className="prose prose-p:text-justify">
            <p>
              ...
              Sagittis id consectetur purus ut faucibus pulvinar elementum. Nibh
              tortor id aliquet lectus proin. Hendrerit dolor magna eget est
              lorem ipsum dolor sit amet. Congue quisque egestas diam in arcu
              cursus euismod quis. Dictumst quisque sagittis purus sit amet
              volutpat. Tempus imperdiet nulla malesuada pellentesque elit eget.
              Commodo viverra maecenas accumsan lacus vel facilisis volutpat.
              Cras sed felis eget velit aliquet sagittis id consectetur. Proin
